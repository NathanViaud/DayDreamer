...
def genTuto():
        ...
        p_saut3 = plateforme(1820, 300, screen, 100, 10, "plat")
        ...
        p_sautfruit4 = plateforme(2790, 250, screen, 100, 10, "plat")
        ...
        f5 = fruit(2600, 180, screen)
        f6 = fruit(2820, 210, screen)
        f7 = fruit(1850, 260, screen)
        fruits.append(f2)
        fruits.append(f3)
        fruits.append(f4)
        fruits.append(f5)
