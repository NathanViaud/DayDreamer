        ...
        while joue:
            ...
            if tutorial == True:
                ...
                if niveaux[level].nuit == True:
                    ...
                    mouvement_tuto = font.render("Utilisez les flèches directionnelles pour bouger", True, white)
                    saut = font.render("Pour sauter utilisez la barre d'espace", True, white)
                    font = pygame.font.Font(None, 30)
                    fruits_message = font.render("Prenez les légumes pour augmenter votre score !", True, white)
                    ...
                    bienvenu = font.render("Bienvenue dans DayDreaming !", True, black)
                    mouvement_tuto = font.render("Utilisez les flèches directionnelles pour bouger", True, black)
