...
class genLevel():
    ...
    def genNiveau1(self):
        ...
        p_cle2 = plateforme(4600, 450, self.screen, 100, 10, "plat")
        for j in range (0,3):
                plateformes.append(plateforme(4800+(j*100), 450, self.screen, 100, 10, "plat"))
        ...
        f8 = fruit(700, 720, self.screen)
        f9 = fruit(900, 720, self.screen)
